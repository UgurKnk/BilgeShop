...
namespace BilgeShop.WebUI.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        [HttpPost]
        public IActionResult Save(ProductFormViewModel formData) // Debug 06.03.2023
        {
            ...
            if (formData.File != null)
            {
                ...
                if (!allowedFileContentTypes.Contains(fileContentType) || !allowedFileExtensions.Contains(fileExtension))
                {
                    ...
                    ViewBag.FileError = "Dosya Formatı veya İçeriği Hatalı.";
                    ViewBag.Categories = _categoryService.GetCategories();
                    return View("Form", formData);
                ...
                // ...wwwroot/images/prdoducts

                var wwwRootFilePath = Path.Combine(wwwRootFolderPath, newFileName);
                // ...wwwroot/images/products/gora-3123wafssd123.jpg

                Directory.CreateDirectory(wwwRootFolderPath);
                // images/products yoksa bile sen oluştur.
            ...
            else // Güncelleme yani id=0 dan farklı
            {
        ...
        [HttpGet]
        public IActionResult Edit(int id) // Debug 06.03.2023
        {
